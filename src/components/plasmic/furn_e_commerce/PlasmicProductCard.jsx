...
import * as sty from "./PlasmicProductCard.module.css" // plasmic-import: sFGOecZNEAdK/css
import ShoppingCartIcon from "./icons/PlasmicIcon__ShoppingCart" // plasmic-import: ARrTn4qfdMRh/icon
import HeartOIcon from "./icons/PlasmicIcon__HeartO" // plasmic-import: DK4XFzC-OV4W/icon
import ExpandIcon from "./icons/PlasmicIcon__Expand" // plasmic-import: 9wWQTyKkznbv/icon
import f1Wh9JMYsfLMt from "./images/f1.jpeg" // plasmic-import: WH9jMYsfL_Mt/picture
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__rJeu8)}
              displayHeight={"auto"}
        ...
        {(hasVariant(variants, "onSale", "onSale") ? true : true) ? (
          <div
            className={classNames(
              ...
              sty.freeBox___6Onez,
              {
                [sty.freeBox__onSale___6OnezdXu0K]: hasVariant(
                  variants,
                  "onSale",
                  "onSale"
                ),
      ...
      {(hasVariant(variants, "withReviews", "withReviews") ? true : true)
        ? p.renderPlasmicSlot({
            defaultContents: (
              <Ratings
                className={classNames("__wab_instance", sty.ratings__o4HsF)}
              />
            ),
